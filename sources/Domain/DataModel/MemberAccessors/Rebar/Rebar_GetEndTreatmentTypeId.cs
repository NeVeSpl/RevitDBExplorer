...
{
    internal class Rebar_GetEndTreatmentTypeId : MemberAccessorByType<Rebar>, IHaveFactoryMethod
    {
        protected override IEnumerable<LambdaExpression> HandledMembers { get { yield return (Rebar x) => x.GetEndTreatmentTypeId(7); } }
        IMemberAccessor IHaveFactoryMethod.Create() => new Rebar_GetEndTreatmentTypeId();
