...
namespace RevitDBExplorer.Domain.DataModel.MemberAccessors
{
    ...
    {
        IEnumerable<LambdaExpression> ICanCreateMemberAccessor.GetHandledMembers() { yield return (RebarBarType x, ElementId i) => x.GetHookTangentLength(i); }      
        ...
        protected override IEnumerable<SnoopableObject> Snooop(Document document, RebarBarType rebarBarType)
        {
            ...
            {
                yield return SnoopableObject.CreateInOutPair(document, hookType, rebarBarType.GetHookTangentLength(hookType.Id));
            }           
        }
    }
}