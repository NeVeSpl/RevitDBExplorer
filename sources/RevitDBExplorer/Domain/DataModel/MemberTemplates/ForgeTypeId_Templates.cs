    ...
    internal class ForgeTypeId_Templates : IHaveMemberTemplates
    {
        ...
        static ForgeTypeId_Templates()
        {
            ForForgeTypeId = new ISnoopableMemberTemplate[]
            {
                ...
                SnoopableMemberTemplate<ForgeTypeId>.Create((doc, forgeId) => doc.GetUnits().GetFormatOptions(forgeId), x => UnitUtils.IsMeasurableSpec(x), Members.Base.MemberKind.AsArgument),
